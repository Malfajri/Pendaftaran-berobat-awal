                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="" method="post">
                                                        ...
                                                        <input type="text" name="hasil_diagnosa" id="hasil_diagnosa" value="" placeholder="Input Diagnosa" required> <br><br>
                                                        
                                                        <input type="text" name="hasil_saran" id="hasil_saran" value="" placeholder="Input Saran" required> <br><br>
